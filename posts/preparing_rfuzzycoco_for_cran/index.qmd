...
I recently released a R package [Rfuzzycoco](https://github.com/Lonza-RND-Data-Science/Rfuzzycoco) that provides
...
to the CRAN, the ecosystem and tools that I use. Some are very common and straightforward.
  ...
  - unit tests: 
    ...
    * I use for that the [testthat](https://testthat.r-lib.org/) package, also integrated in [devtools](https://devtools.r-lib.org/)
    ...
    * I just achieved **100% test coverage**, for both the R and C++ Rfuzzycoco code (excluding the fuzzycoco lib code which
    by the way has also 100% test coverage)
  - R CMD check: 
  ...
  - github (or equivalent devops platform). I will only discuss github here since it is what I'm using for Rfuzzycoco
...
for other packages. And I think one thing that is lacking is a standard R package project that would implement all this kind of 
...
Stay tuned for more news on the Rfuzzycoco CRNA journey.
